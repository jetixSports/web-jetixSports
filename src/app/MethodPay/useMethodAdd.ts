    ...
    fields: {
      ...
      details: {
        email: register('details.email', {
          required: paymentType === 'binance' ? 'Email obligatorio para Binance' : false,
          pattern:
            paymentType === 'binance'
              ? {
        ...
        bankNumber: register('details.bankNumber', {
          required: paymentType === 'bank_transfer' ? 'Número de cuenta obligatorio' : false,
          minLength:
        ...
        mobileCode: register('details.mobileCode', {
          required: paymentType === 'mobile_payment' ? 'Código de banco obligatorio' : false,
          maxLength:
