...
export default function page({ params: { _idStream } }: { params: { _idStream: string } }) {
    const findStream = useStream({ _id: _idStream, status: "ALL" })

    const createStream = useUpdateStream({ def: findStream.stream?.[0] })
    return (
